...
With only **$1,034.42**, the North shows the weakest performance.

### **4. High Average Order Value ($204.08)**
Customers spend over **$200 per order**, indicating strong purchasing behavior.
...
Stationery contributes only **$322**, suggesting low profitability.
...
2. Open the SQL script in `/sql/retail_sales_analysis.sql`  
3. Run the cleaning section  
4. Run the KPI and analysis queries  
